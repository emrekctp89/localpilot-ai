...
Migration: Supabase’de `012_mini_site_domains.sql` uygulanmalı.
...
5. Migration: `012_mini_site_domains.sql` — slug / custom domain kolonları (henüz uygulandıysa atla).
6. RLS iki-hesap testi isteğe bağlı — `docs/production-checklist.md` §5.
