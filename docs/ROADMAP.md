...
6. Migration: `013_resolve_mini_site_domain.sql` — middleware domain RPC (Supabase SQL Editor).
7. Migration: `014_manual_pro_commission.sql` — manuel Pro komisyon RPC Supabase’de uygulandı.
8. Migration: `015_backfill_site_slugs.sql` — mevcut işletmelere slug (uygula).
9. **Sonra — Vercel env (G.3 canlı doğrulama):** aşağıya bak.
8. RLS iki-hesap testi isteğe bağlı — `docs/production-checklist.md` §5.
